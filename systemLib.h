...
#define TIMEOUT_ACTUALIZA_JUEGO_2 500 // Primer decremento del timeout
#define TIMEOUT_ACTUALIZA_JUEGO_3 250 // Segundo decremento del timeout
...
#define FLAG_PAUSA_JUEGO	0x20  // Flag de pausa
